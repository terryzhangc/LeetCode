...
namespace LeetCode.Tests
{
    public class ST_0001_1000
    {
        ...
        {
            var result1 = _s.ThreeSum(new int[] { -1, 0, 1, 2, -1, -4 });
            var result = _s.ThreeSum(_bigArray);
        ...
        [Fact]
        public void LC_0016_ThreeSumClosest_Test()
        {
        ...
        [Fact]
        public void LC_0036_IsValidSudoku_Test()
        {
            Assert.True(_s.IsValidSudoku(new char[,] {
                {'5', '3', '.', '.', '7', '.', '.', '.', '.'},
                {'6', '.', '.', '1', '9', '5', '.', '.', '.'},
                {'.', '9', '8', '.', '.', '.', '.', '6', '.'},
                {'8', '.', '.', '.', '6', '.', '.', '.', '3'},
            ...
            Assert.False(_s.IsValidSudoku(new char[,] {
                {'8', '3', '.', '.', '7', '.', '.', '.', '.'},
                {'6', '.', '.', '1', '9', '5', '.', '.', '.'},
                {'.', '9', '8', '.', '.', '.', '.', '6', '.'},
                {'8', '.', '.', '.', '6', '.', '.', '.', '3'},
        ...
        [Fact]
        public void LC_0037_SolveSudoku_Test()
        {
            var m = new char[,] {
                {'5', '3', '.', '.', '7', '.', '.', '.', '.'},
                {'6', '.', '.', '1', '9', '5', '.', '.', '.'},
